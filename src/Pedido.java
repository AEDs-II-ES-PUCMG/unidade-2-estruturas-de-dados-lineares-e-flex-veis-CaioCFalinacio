...
public class Pedido implements Comparable<Pedido> {
	...
	private Lista<ItemDePedido> listaItemDePedido;
	...
	public ItemDePedido existeNoPedido(Produto produto) {
		...
		return listaItemDePedido.buscarPor(criterio, itemDePedidoProcurado);
	}
	...
	public String toString() {
		...
		stringPedido.append("Pedido com " + listaItemDePedido.tamanho() + " itens.\n");
		stringPedido.append("Itens de pedido no pedido:\n");
		for (int i = 0; i < listaItemDePedido.tamanho(); i++) {
